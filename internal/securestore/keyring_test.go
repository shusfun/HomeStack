...
func testDeviceProfile() DeviceProfile {
	...
	return DeviceProfile{
		...
		ManagedContent: &managed.Profile{
			...
			FileBrowser:      managed.Installation{Component: "filebrowser", Version: "0.3.5", ArtifactSHA256: strings.Repeat("a", 64), Executable: contentRoot + "/components/filebrowser/filebrowser", Root: contentRoot + "/components/filebrowser"},
			Jellyfin:         managed.Installation{Component: "jellyfin", Version: "10.11.11", ArtifactSHA256: strings.Repeat("b", 64), Executable: contentRoot + "/components/jellyfin/jellyfin", Root: contentRoot + "/components/jellyfin", WebDir: contentRoot + "/components/jellyfin/jellyfin-web", FFmpeg: contentRoot + "/components/jellyfin/ffmpeg"},
